...
from .api.routes.exercise_needed import router as exercise_needed_router
from .api.routes.health import router as health_router
from .api.routes.users import router as users_router
from .api.routes.workouts import router as workouts_router
from .database import initialize_database
from .models import Activity, ExerciseNeededEntry, User, WorkoutEntry  # noqa: F401
...
app.include_router(exercise_needed_router, prefix="/api/exercise-needed", tags=["exercise-needed"])
